											...
											<tr>
												<td id="template_header_image">
													...
													if ( $img ) {
														...
														echo '<p class="email-logo-text"><a href="' . esc_url( $header_image_url ) . '" style="color: inherit; text-decoration: none;" target="_blank">Noyona Essentials</a></p>';
														echo '<p class="noyona-email-tagline">' . esc_html__( 'BEAUTY ROOTED IN NATURE', 'noyona-childtheme' ) . '</p>';
													} else {
														echo '<p class="email-logo-text">Noyona Essentials</p>';
														echo '<p class="noyona-email-tagline">' . esc_html__( 'BEAUTY ROOTED IN NATURE', 'noyona-childtheme' ) . '</p>';
													}
													?>
												</td>
									...
									<?php else : ?>
										<div id="template_header_image">
											...
											if ( $img ) {
												...
												echo '<p class="email-logo-text"><a href="' . esc_url( home_url( '/' ) ) . '" style="color: inherit; text-decoration: none;" target="_blank">Noyona Essentials</a></p>';
												echo '<p class="noyona-email-tagline">' . esc_html__( 'BEAUTY ROOTED IN NATURE', 'noyona-childtheme' ) . '</p>';
											}
											?>
										</div>

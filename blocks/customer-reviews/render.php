...
<section <?php echo $wrapper_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
    <?php if ( '' !== $review_notice ) : ?>
        <p class="noyona-notice is-success" role="status" data-noyona-notice-key="customer-reviews" data-noyona-notice-autohide="10000"><?php echo esc_html( $review_notice ); ?></p>
    <?php endif; ?>

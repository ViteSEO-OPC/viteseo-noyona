...
function woocom_ct_enqueue_assets() {
    ...
    $shop_product_brands = array();
    if ( $is_shop_archive && function_exists( 'noyona_get_shop_filter_product_brands' ) ) {
        $shop_product_brands = noyona_get_shop_filter_product_brands();
    }
